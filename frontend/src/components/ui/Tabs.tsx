...
import { cn } from "./Button" // Assuming cn is in Button.tsx or a utils file
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center rounded-md bg-muted p-1 text-muted-foreground overflow-x-auto max-w-full scrollbar-thin",
      className
    )}
    {...props}
  />
